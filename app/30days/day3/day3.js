    ...
    render() {
        return (
          ...
          <RefreshControl
            ...
            tintColor="#ddd"/>}>
                <Image source={{uri:'day3'}}
                       style={{width:DisplayUtil.size.width, height:DisplayUtil.size.height-110}}></Image>
            </ScrollView>
        )
    }
}
    ...
    render() {
        ...
        return (
            <View style={styles.twitterContainer}>
                <View style={[{backgroundColor:'teal',flex:1,justifyContent:'center'}]}>
                    <Text>{'title'}</Text>
                </View>
                {entrance}
            </View>
...
const styles = StyleSheet.create({
    ...
    twitterContainer: {
        ...
        height: DisplayUtil.size.height
    },
    entrance: {
        position: "absolute",
        top: 0, left: 0,
    ...
    nav: {
        flexDirection: "row",
        paddingTop: 30,
        borderBottomWidth: DisplayUtil.pixel,
    ...
    twitterPostContainer: {
        width: DisplayUtil.size.width,
        height: DisplayUtil.size.height - 90,
        position: "relative",
        top: -20
    },
});
