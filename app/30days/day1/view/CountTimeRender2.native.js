        ...
        return (
            <View style={styles.divRoot}>
                ...
                <View style={styles.divRootPannel}>
                    <TouchableOpacity style={styles.labelButtonDiv} onPress={this.start.bind(this)}>
                        <Text style={styles.labelButton}>{'开始'}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.labelButtonDiv} onPress={this.reset.bind(this)}>
...
module.exports = {CountTimeComponent};