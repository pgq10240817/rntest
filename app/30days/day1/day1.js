...
import {
    ListView,StyleSheet,Text,TouchableHighlight,View
}from 'react-native';
...
export default class extends Component {
    ...
    _count = ()=> {
        ...
        countingTime = this.state.timeAccumulation + currentTime - this.state.initialTime;
        ...
        let totalTimeStr =
            (minute < 10 ? "0" + minute : minute) + ":" + (second < 10 ? "0" + second : second) + "." + (milSecond < 10 ? "0" + milSecond : milSecond);
        let seciotnTimeStr =
            (secminute < 10 ? "0" + secminute : secminute) + ":" + (secsecond < 10 ? "0" + secsecond : secsecond) + "." + (secmilSecond < 10 ? "0" + secmilSecond : secmilSecond);
        this.setState({
            currentTime: currentTime,
            totalTime: totalTimeStr,
            sectionTime: seciotnTimeStr,
